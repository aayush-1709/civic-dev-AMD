...
export default function AIReportModal({ isOpen, onClose }: AIReportModalProps) {
  ...
  const handleDownload = () => {
    ...
    const generatePdf = async () => {
      ...
      doc.setFontSize(16);
      doc.text('Municipal Civic Intelligence Report', margin, cursorY);
      ...
      doc.save(`civic-government-report-${fileDate}.pdf`);
    };
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl">
            AI-Generated Weekly Civic Intelligence Report
          </DialogTitle>
          <DialogDescription className="sr-only">
            Generated civic intelligence report with issue, pincode, and cluster level insights.
          </DialogDescription>
        </DialogHeader>
