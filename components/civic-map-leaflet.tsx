      ...
      <CardContent className="p-0">
        <div className="relative w-full h-72 sm:h-80 border border-slate-200 rounded-lg overflow-hidden bg-slate-100">
          ...
          <div className="absolute top-3 left-3 right-3 z-10 flex flex-wrap items-center gap-2">
            ...
            <Badge
              variant="secondary"
              className="bg-red-100 text-red-800 border border-red-200 text-[11px] sm:text-xs"
            >
              High: Red
            </Badge>
            <Badge
              variant="secondary"
              className="bg-yellow-100 text-yellow-800 border border-yellow-200 text-[11px] sm:text-xs"
            >
              Low: Yellow
            </Badge>
            <Badge
              variant="secondary"
              className="bg-green-100 text-green-800 border border-green-200 text-[11px] sm:text-xs"
            >
              Less/None: Green
            </Badge>
          </div>
